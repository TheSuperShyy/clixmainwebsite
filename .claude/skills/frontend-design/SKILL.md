...
The DESIGN.md format specification is in `docs/reference/design-references/design-md-format.md`. Reference DESIGN.md files from real brand websites (Stripe, Apple, Airbnb, Nike, Linear, etc.) are in `docs/reference/design-references/references/by-aesthetic/`.
