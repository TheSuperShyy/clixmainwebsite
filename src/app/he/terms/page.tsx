/**
 * /he/terms — thin route shell. The page BODY lives in src/app/_routes/LegalRoute.tsx and is
...
export const metadata: Metadata = {
  title: "תנאי שימוש",
  description: "התנאים החלים על השימוש באתר Clix, בתכניו ובעוגיות שבו.",
};

export const revalidate = 300;

export default function Page() {
  return <LegalRoute locale="he" namespace="terms" />;
}
