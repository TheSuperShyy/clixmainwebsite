/**
 * /he/security — thin route shell.
 *
 * The page BODY lives in src/app/_routes/SecurityRoute.tsx and is shared with /security.
...
import SecurityRoute from "@/app/_routes/SecurityRoute";
...
export default function Page() {
  return <SecurityRoute locale="he" />;
}
