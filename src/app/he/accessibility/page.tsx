/**
 * /he/accessibility — thin route shell. The page BODY lives in src/app/_routes/LegalRoute.tsx and is
...
export const metadata: Metadata = {
  title: "הצהרת נגישות",
  description: "כיצד Clix פועלת להנגשת האתר, לפי אילו תקנים, וכיצד ליצור קשר עם רכז הנגישות.",
};

export const revalidate = 300;

export default function Page() {
  return <LegalRoute locale="he" namespace="accessibility" />;
}
