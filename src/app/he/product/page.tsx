/**
 * /he/product — thin route shell.
 *
 * The page BODY lives in src/app/_routes/ProductRoute.tsx and is shared with /product.
...
import ProductRoute from "@/app/_routes/ProductRoute";
...
export const metadata: Metadata = {
  ...
  /* Copied verbatim from the English twin, and it MUST be. Every one of the four
     ...
     none of them — see the route header in _routes/ProductRoute.tsx. */
